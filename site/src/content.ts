      ...
      blocks: [
        {
          ...
          heading: 'What Is Spec-Driven Development?',
          paragraphs: [
            'A specification is a document with an unambiguous description of what needs to be done. A contract for development and verification.',
      ...
      blocks: [
        {
          ...
          heading: 'Что такое Spec-Driven Development?',
          paragraphs: [
            'Спецификация — это документ с однозначным описанием того, что нужно сделать. Контракт для разработки и проверки.',
      ...
      blocks: [
        {
          ...
          heading: '¿Qué es Spec-Driven Development?',
          paragraphs: [
            'Una especificación es un documento con una descripción inequívoca de lo que hay que hacer. Un contrato para desarrollar y verificar.',
      ...
      blocks: [
        {
          ...
          heading: '什么是 Spec-Driven Development？',
          paragraphs: [
            '规格是一份文档，用明确无歧义的方式说明需要做什么。它是开发和验证的契约。',
