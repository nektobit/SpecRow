...
export const docContent: Record<LocaleCode, Record<PageSlug, PageContent>> = {
  en: {
    ...
    instructions: {
      ...
      blocks: [
        { type: 'command-section', heading: 'Install Through An Agent', intro: 'Start with the agent installer and pass the project working language explicitly.', commands: ['apply https://raw.githubusercontent.com/nektobit/SpecRow/refs/heads/main/install language=en'], outro: 'The agent checks or installs the CLI, initializes .specrow with that language, installs agent integrations, validates the workspace, and reports whether the IDE or agent needs a restart.' },
  ...
  ru: {
    ...
    instructions: {
      ...
      blocks: [
        { type: 'command-section', heading: 'Установка через агента', intro: 'Начинайте с agent installer и явно передавайте рабочий язык проекта.', commands: ['apply https://raw.githubusercontent.com/nektobit/SpecRow/refs/heads/main/install language=ru'], outro: 'Агент проверит или установит CLI, инициализирует .specrow с этим языком, установит интеграции агентов, запустит валидацию и сообщит, нужно ли перезапустить IDE или агента.' },
  ...
  es: {
    ...
    instructions: {
      ...
      blocks: [
        { type: 'command-section', heading: 'Instalar mediante un agente', intro: 'Empieza con el agent installer y pasa explícitamente el idioma de trabajo del proyecto.', commands: ['apply https://raw.githubusercontent.com/nektobit/SpecRow/refs/heads/main/install language=es'], outro: 'El agente comprueba o instala la CLI, inicializa .specrow con ese idioma, instala integraciones de agentes, valida el workspace e informa si el IDE o agente necesita reinicio.' },
  ...
  'zh-CN': {
    ...
    instructions: {
      ...
      blocks: [
        { type: 'command-section', heading: '通过代理安装', intro: '优先使用 agent installer，并显式传入项目工作语言。', commands: ['apply https://raw.githubusercontent.com/nektobit/SpecRow/refs/heads/main/install language=zh-CN'], outro: '代理会检查或安装 CLI，使用该语言初始化 .specrow，安装代理集成，验证 workspace，并报告 IDE 或代理是否需要重启。' },
