  ...
  en: {
    ...
    'mcp-server': {
      ...
      blocks: [
        ...
        { type: 'section', heading: 'CLI Fallback', paragraphs: ['The specrow CLI remains the manual fallback for CI, scripts, and clients without MCP. If MCP is unavailable, the agent can run the same operations through the CLI.'], commands: ['specrow validate [change-name]', 'specrow context [change-name]', 'specrow integrations status'] },
      ],
    },
    'cli-reference': {
      eyebrow: 'CLI Core',
  ...
  ru: {
    ...
    'mcp-server': {
      ...
      blocks: [
        ...
        { type: 'section', heading: 'CLI fallback', paragraphs: ['CLI specrow остается ручным fallback для CI, скриптов и клиентов без MCP. Если MCP недоступен, агент может выполнить те же операции через CLI.'], commands: ['specrow validate [change-name]', 'specrow context [change-name]', 'specrow integrations status'] },
      ],
    },
    'cli-reference': {
      eyebrow: 'CLI Core',
  ...
  es: {
    ...
    'mcp-server': {
      ...
      blocks: [
        ...
        { type: 'section', heading: 'Fallback CLI', paragraphs: ['La CLI specrow sigue siendo el fallback manual para CI, scripts y clientes sin MCP. Si MCP no está disponible, el agente puede ejecutar las mismas operaciones mediante CLI.'], commands: ['specrow validate [change-name]', 'specrow context [change-name]', 'specrow integrations status'] },
      ],
    },
    'cli-reference': {
      eyebrow: 'CLI Core',
  ...
  'zh-CN': {
    ...
    'mcp-server': {
      ...
      blocks: [
        ...
        { type: 'section', heading: 'CLI fallback', paragraphs: ['specrow CLI 仍然是 CI、脚本和不支持 MCP 的客户端的手动 fallback。如果 MCP 不可用，代理可以通过 CLI 执行相同操作。'], commands: ['specrow validate [change-name]', 'specrow context [change-name]', 'specrow integrations status'] },
      ],
    },
    'cli-reference': {
      eyebrow: 'CLI Core',
